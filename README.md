# Applitools Example: Selenium in Java with TestNG

This is the example project for the [Selenium Java TestNG tutorial].
...
* [TestNG v7.5](https://github.com/testng-team/testng/tree/7.5) as the core test framework
...
The main test case is [`DemoPageTests.java`](src/test/java/com/applitools/example/DemoPageTests.java).
